...
<div class="careers-page-container  vacancy-page-container">
  <div class="careers-page-container-header" style="background-image: url(<?php echo get_stylesheet_directory_uri();?>/src/assets/images/products/background.png);" >
    ...
    <div class="careers-header-title">
      ...
      <!-- <h1><?php the_title();?></h1> -->
      <a class="button join-team-button" href="<?php echo esc_url( home_url( '/vacancies/#vacancies' ) ); ?>"><i class="icon-left"></i> Back to all jobs</a>
  </div>
  ...
  <div class="vacancy-container" id="vacancy">
            ...
            <div class="vacancy">
              <div class="vacancy-header">
                ...
                <div class="apply">
                  ...
                  <a href="<?php echo esc_url(add_query_arg( array("job" => $job, "job_type" => $job_type), site_url('/apply-now/#apply')))?>" class="button" >Apply Now <i class="icon-right"></i> </a>
                </div>
              </div>
