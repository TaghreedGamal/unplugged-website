...
$('.sd-content ul').append("<li class='share-link'><span class='icon-container link' href='#' title='Copy link to clipboard'> <i class='icon-link'></i> </span></li>")
///copy to clip board
// var copyBtn = document.querySelector('.sd-content ul li.share-link');
// copyBtn.addEventListener('click', function(event) {
//   // Select the email link anchor text
//   var url = window.location.href;
//   var range = document.createRange();
//   range.selectNode(url);
//   window.getSelection().addRange(url);
//
//   try {
...
$('.sd-content ul li.share-link').on('click', function(){
  CopyLink();
})
