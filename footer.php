...
<footer class="footer">
<!--
<form method="post" enctype="multipart/form-data" id="gform_6" class="subsc" action="/unplugged/">
   	<div class="input-group">
<input name="input_1" id="input_6_1" type="text" value="" class="small" tabindex="1" placeholder="username@domain.com"><div class="input-group-button">
<input type="submit" id="gform_submit_button_6" class="gform_button button" value="Subscribe" tabindex="2" onclick="if(window[&quot;gf_submitting_6&quot;]){return false;}  window[&quot;gf_submitting_6&quot;]=true;  "></div>
	</div>
</form>
-->

    <div class="footer-container">
      <div class="left"> <img class="lefti" src="<?php echo get_stylesheet_directory_uri(); ?>/src/assets/images/home/foo_big_circle.png">
...
<!--
        <div class="newsletter">
            <p>Subscribe to our newsletter, and never miss a single update of Unplugged.</p>
...
-->
        ...
        <div class="right "> <img class="righti" src="<?php echo get_stylesheet_directory_uri(); ?>/src/assets/images/home/foo_gbig_circle.png">
