...
var _whatInput = __webpack_require__(23);

var _whatInput2 = _interopRequireDefault(_whatInput);

var _slickCarousel = __webpack_require__(24);
...
var _TweenMax = __webpack_require__(26);
...
var contactSteps = (0, _jquery2.default)(".step");
(0, _jquery2.default)('[data-click]').on('click', openContact);
...
(0, _jquery2.default)('[next-click]').on('click', function () {
...
(0, _jquery2.default)('[close-click]').on('click', function () {
    var x = document.getElementById("demo1");
    x.style.display = "none";
});
(0, _jquery2.default)('[close1-click]').on('click', function () {
    var x = document.getElementById("demo2");
    x.style.display = "none";
});
(0, _jquery2.default)('[close2-click]').on('click', function () {
    var x = document.getElementById("demo");
    x.style.display = "none";
});
(0, _jquery2.default)('[close-menu]').on('click', function () {
    //    var x =  document.getElementById("menu");
    //    x.style.display = "none";
    (0, _jquery2.default)(".full-menu").removeClass("active");
});

(0, _jquery2.default)('[menu-click]').on('click', function () {
    (0, _jquery2.default)(".full-menu").addClass("active");
});
...
if ((0, _jquery2.default)(".home").length != 0) {
    ...
    (0, _jquery2.default)(document).ready(function () {
        (0, _jquery2.default)('.home-slider__responsive__slides').slick({
            infinite: true,
            speed: 500,
            slidesToShow: 1,
            slidesToScroll: 1,
    ...
    (0, _jquery2.default)(document).ready(function () {
        (0, _jquery2.default)('.clients').slick({
            centerMode: true,
            centerPadding: '60px',
            slidesToShow: 6,
            autoplay: true,
    ...
    // slide animation
    var path1 = (0, _jquery2.default)("#Slidfun path"),
        length1 = path1[0].getTotalLength();
    var path2 = (0, _jquery2.default)(".fun3 path"),
        length2 = path2[0].getTotalLength();
    var path3 = (0, _jquery2.default)(".fun4 path"),
        length3 = path3[0].getTotalLength();
    var path4 = (0, _jquery2.default)("#Slidflex path"),
        length4 = path4[0].getTotalLength();
    var path5 = (0, _jquery2.default)(".flex6 path"),
        length5 = path5[0].getTotalLength();
    var path6 = (0, _jquery2.default)(".flex0 path"),
        length6 = path6[0].getTotalLength();
    var path7 = (0, _jquery2.default)("#Slidinv path"),
        length7 = path7[0].getTotalLength();
    var path8 = (0, _jquery2.default)(".inv9 path"),
        length8 = path8[0].getTotalLength();
    var path9 = (0, _jquery2.default)(".inv0 path"),
        length9 = path9[0].getTotalLength();
    var path10 = (0, _jquery2.default)(".fun11 path"),
        length10 = path10[0].getTotalLength();
    var path11 = (0, _jquery2.default)(".fun12 path"),
        length11 = path11[0].getTotalLength();

    var tl = new TimelineMax();
    tl.set(path1, { attr: { "stroke-dasharray": length1, "stroke-dashoffset": length1 } }).set(path2, { attr: { "stroke-dasharray": length2, "stroke-dashoffset": length2 } }).set(path3, { attr: { "stroke-dasharray": length3, "stroke-dashoffset": length3 } }).set(path4, { attr: { "stroke-dasharray": length4, "stroke-dashoffset": length4 } }).set(path5, { attr: { "stroke-dasharray": length5, "stroke-dashoffset": length5 } }).set(path6, { attr: { "stroke-dasharray": length6, "stroke-dashoffset": length6 } }).set(path7, { attr: { "stroke-dasharray": length7, "stroke-dashoffset": length7 } }).set(path8, { attr: { "stroke-dasharray": length8, "stroke-dashoffset": length8 } }).set(path9, { attr: { "stroke-dasharray": length9, "stroke-dashoffset": length9 } }).set(path10, { attr: { "stroke-dasharray": length10, "stroke-dashoffset": length10 } }).set(path11, { attr: { "stroke-dasharray": length11, "stroke-dashoffset": length11 } });

    var tl1 = new _TweenMax.TimelineLite({ onComplete: function onComplete() {
            this.restart();
        }
    });

    tl1.to('.dot1', 0.5, { backgroundColor: "#003a47", width: 60 }).addLabel("t").to(".hi1", 1, { y: -50, overflowY: 'visible' }, "t+=0.2")
    //.from(".Stitle1", 1, {overflowY:'hidden'},"t+=0.2")
    .to(".Stitle1", 1, { overflowY: 'visible' }, "t+=0.5")
    //.from(".Stitle4", 1, {overflowY:'hidden'},"t+=0.5")
    .to(".Stitle4", 1, { overflowY: 'visible' }, "t+=0.7").to("#Slidfun", 0.6, { opacity: 1 }).to(path1, 0.6, { attr: { "stroke-dashoffset": 0 }, opacity: 0.749 }).from(".fadeInUp", 0.7, { yPercent: 50, opacity: 0 }).from(".zoom", 1.5, { scale: 0.2, opacity: 0 }).addLabel("both").to(path2, 0.6, { attr: { "stroke-dashoffset": 0 }, opacity: 0.749 }, "both").to(path3, 0.6, { attr: { "stroke-dashoffset": 0 }, opacity: 0.749 }, "both").from(".bouncess", 0.5, { y: -50, scale: 0.9, opacity: 0 }).addLabel("both3").from(".show1", 0.5, { y: 100, opacity: 0 }, "both3").from(".show2", 0.5, { y: 100, opacity: 0 }, "both3+=0.1").to(path10, 0.6, { attr: { "stroke-dashoffset": 0 }, opacity: 1 }, "both3").to(path11, 0.6, { attr: { "stroke-dashoffset": 0 }, opacity: 1 }, "both3+=0.1").addLabel("fly", '+=1.5').to(".bouncess", 0.5, { y: -50, opacity: 0 }, "fly").to(path2, 0.2, { y: -100, opacity: 0 }, "fly+=0.1").to(path3, 0.2, { y: -100, opacity: 0 }, "fly+=0.2").to(path10, 0.2, { y: -100, opacity: 0 }, "fly+=0.3").to(path11, 0.2, { y: -100, opacity: 0 }, "fly+=0.4").to(".show1", 0.2, { y: -100, opacity: 0 }, "fly+=0.5").to(".show2", 0.2, { y: -100, opacity: 0 }, "fly+=0.6").to(".zoom", 0.8, { yPercent: -100, opacity: 0 }, "fly+=0.7").to(".fadeInUp", 0.7, { yPercent: -100, opacity: 0 }, "fly+=0.8").to(path1, 0.2, { opacity: 0 }, "fly+=0.9")
    //.to(".Stitle", 0.5, {yPercent:-100,opacity:0})
    .to('.dot1', 0.5, { backgroundColor: "#a9a9a9", width: 40 }, "fly+=1").to('.dot2', 0.5, { backgroundColor: "#003a47", width: 60 })
    //.from(".Stitle2", 0.8, {yPercent:100,scale:0.5,delay:0.6,opacity:0})
    .to("#Slidflex", 0.8, { opacity: 1, delay: 0.2 }).to(path4, 0.8, { attr: { "stroke-dashoffset": 0 }, opacity: 0.749 }).from(".fadeInUp2", 0.7, { yPercent: 50, opacity: 0 }).from(".zoom2", 1.5, { scale: 0.2, opacity: 0 }).addLabel("both2").to(path5, 0.6, { attr: { "stroke-dashoffset": 0 }, opacity: 0.749 }, "both2").to(path6, 0.6, { attr: { "stroke-dashoffset": 0 }, opacity: 0.749 }, "both2").from(".bouncess2", 0.5, { x: -10, scale: 0.9, opacity: 0 }).addLabel("both4").from(".show11", 0.5, { y: 100, opacity: 0 }, "both4").from(".show22", 0.5, { y: 100, opacity: 0 }, "both4+=0.1").addLabel("fly1", '+=1.5').to(".bouncess2", 0.5, { x: -10, scale: 1, opacity: 0 }, "fly1").to(path5, 0.2, { y: -100, opacity: 0 }, "fly1+=0.1").to(path6, 0.2, { y: -100, opacity: 0 }, "fly1+=0.2").to(".show11", 0.2, { y: -100, opacity: 0 }, "fly1+=0.3").to(".show22", 0.2, { y: -100, opacity: 0 }, "fly1+=0.4").to(".zoom2", 0.8, { yPercent: -100, opacity: 0 }, "fly1+=0.5").to(".fadeInUp2", 0.7, { yPercent: -100, opacity: 0 }, "fly1+=0.6").to(path4, 0.2, { opacity: 0 }, "fly1+=0.7")
    //.to(".Stitle2", 0.5, {yPercent:-100,opacity:0})
    .to('.dot2', 0.5, { backgroundColor: "#a9a9a9", width: 40 }, "fly1+=0.8").to('.dot3', 0.5, { backgroundColor: "#003a47", width: 60 })
    //.from(".Stitle3", 0.8, {yPercent:100,scale:0.5,delay:0.6,opacity:0})
    .to("#Slidinv", 0.8, { opacity: 1, delay: 0.2 }).to(path7, 0.6, { attr: { "stroke-dashoffset": 0 }, opacity: 0.749 }).from(".fadeInUp3", 0.7, { yPercent: 50, opacity: 0 }).from(".zoom3", 1.5, { scale: 0.2, opacity: 0 }).addLabel("both3").to(path8, 0.6, { attr: { "stroke-dashoffset": 0 }, opacity: 0.749 }, "both3").to(path9, 0.6, { attr: { "stroke-dashoffset": 0 }, opacity: 0.749 }, "both3").from(".bouncess3", 0.5, { x: 50, scale: 0.9, opacity: 0 }).addLabel("both5").from(".show111", 0.5, { y: 100, opacity: 0 }, "both5").from(".show222", 0.5, { y: 100, opacity: 0 }, "both5+=0.1").addLabel("fly2", '+=1.5').to(".bouncess3", 0.5, { x: 50, scale: 1, opacity: 0 }, "fly2").to(path8, 0.2, { y: -100, opacity: 0 }, "fly2+=0.1").to(path9, 0.2, { y: -100, opacity: 0 }, "fly2+=0.2").to(".show111", 0.2, { y: -100, opacity: 0 }, "fly2+=0.3").to(".show222", 0.2, { y: -100, opacity: 0 }, "fly2+=0.4").to(".zoom3", 0.8, { yPercent: -100, opacity: 0 }, "fly2+=0.5").to(".fadeInUp3", 0.7, { yPercent: -100, opacity: 0 }, "fly2+=0.6").to(path7, 0.2, { opacity: 0 }, "fly2+=0.7")
    //.to(".Stitle3", 0.5, {yPercent:-100,opacity:0})
    .to('.dot3', 0.5, { backgroundColor: "#a9a9a9", width: 40 }, "fly2+=0.8");

    var Bottomslider = (0, _jquery2.default)(".project-section").offset().top;
    (0, _jquery2.default)(window).scroll(function () {
        if ((0, _jquery2.default)(window).scrollTop() * 8 > Bottomslider) {
            tl1.pause();
            //            console.log('jjjjjj');
        } else {
            tl1.play();
    ...
    (0, _jquery2.default)('#example-tabs').on('change.zf.tabs', function () {
        var activeTab = (0, _jquery2.default)(".tabs-panel.is-active");
        if (activeTab.length) {
            ...
            if (servicesTimelines[service]) {
                ...
                servicesTimelines[service].addLabel("with").from(title, 0.3, { x: -100, opacity: 0 }, "with").from(text, 0.3, { x: -100, opacity: 0 }, "with+=0.1").from(button, 0.3, { x: -100, opacity: 0 }, "with+=0.2").from(img, 0.4, { x: -500, opacity: 0 }, "with+=0.4").from(circle, 0.7, { scale: 0.2, opacity: 0 }, "with+=0.6").from(shape, 0.4, { x: -200, opacity: 0 }, "with+=0.7").from(screen, 0.4, { x: 200, opacity: 0 }, "with+=0.7").from(lines, 0.5, { y: 200, opacity: 0 }, "with+=1").from(draw, 0.5, { x: -100, opacity: 0 }, "with+=1");
            }
        }
    ...
    ////// project animation
    var screenSize = (0, _jquery2.default)(window).width();
    if (screenSize > '480') {
        var projectTimelines = {};
        (0, _jquery2.default)('#collapsing-tabs').on('change.zf.tabs', function () {
            var activeTab2 = (0, _jquery2.default)('.projtabs').find('.is-active');
            if (activeTab2.length) {
                ...
                if (projectTimelines[container]) {
                    ...
                    projectTimelines[project].addLabel("go").from(container, 0.3, { scaleX: 0, transformOrigin: "right" }, "go").from(box1, 0.5, { x: 10, opacity: 0, scaleX: 0, transformOrigin: "right" }, "go+=0.2").from(img1, 0.6, { x: 800, opacity: 0 }).from(img2, 0.4, { scale: 0.2, opacity: 0 });
                }
            }
        });
    }
    ...
    var path1 = (0, _jquery2.default)("#imgl1 path"),
        length1 = path1[0].getTotalLength();
    var path2 = (0, _jquery2.default)("#imgl2 path"),
        length2 = path2[0].getTotalLength();

    var tl = new TimelineMax();
    tl.set(path1, { attr: { "stroke-dasharray": length1, "stroke-dashoffset": length1 } }).set(path2, { attr: { "stroke-dasharray": length2, "stroke-dashoffset": length2 } });

    var inl = new TimelineMax();
    inl.from("#box1", 0.5, { y: -150, opacity: 0 }, 1).from("#box2", 0.5, { y: -150, opacity: 0 }, 1).from("#box1-img", 0.6, { y: 300, opacity: 0 }, 1).from("#box2-img", 0.6, { y: 300, opacity: 0 }, 1).addLabel("cir").from(".circle", 1, { scale: 0.2, opacity: 0 }, "cir").from(".circle2", 1, { scale: 0.2, opacity: 0 }, "cir").addLabel("line").from(".left-boxline", 0.5, { y: 200, opacity: 0 }, "line").from(".right-boxline2", 0.5, { y: 200, opacity: 0 }, "line").addLabel("sline").from(".left-boximgline-1", 0.5, { y: 200, opacity: 0 }, "sline").from(".right-boximg2line-1", 0.5, { y: 200, opacity: 0 }, "sline").from(".left-boximgline-2", 0.5, { y: 200, opacity: 0 }, "sline").from(".right-boximg2line-2", 0.5, { y: 200, opacity: 0 }, "sline").addLabel("draw").to(path1, 0.6, { attr: { "stroke-dashoffset": 0 }, opacity: 1 }, "draw").to(path2, 0.6, { attr: { "stroke-dashoffset": 0 }, opacity: 1 }, "draw+=0.4");
    inl.pause();

    (0, _jquery2.default)(window).scroll(function () {
        var inter = (0, _jquery2.default)(".intern");
        ...
        var bottom_of_screen = (0, _jquery2.default)(window).scrollTop() + window.innerHeight;
    ...
    card.from(".datacard", 0.8, { x: 500, opacity: 0 }).from(".kora", 0.8, { scale: 0.2, opacity: 0 }).from(".cardl", 0.6, { y: 200, opacity: 0 }).from(".obj", 0.6, { x: 200, opacity: 0 });
    card.pause();
    (0, _jquery2.default)(".card1, .card2, .card3, .card4").hover(function () {
        (0, _jquery2.default)(this).find(".card").addClass('cardhover');
        (0, _jquery2.default)(this).find(".obj").addClass('objhover');
        (0, _jquery2.default)(this).find(".datacard").addClass('dcardhover');
        (0, _jquery2.default)(this).find(".kora").addClass('dcardhover');
        (0, _jquery2.default)(this).find("p.card-no").addClass('cardno-hover');
    }, function () {
        (0, _jquery2.default)(this).find(".card").removeClass('cardhover');
        (0, _jquery2.default)(this).find(".obj").removeClass('objhover');
        (0, _jquery2.default)(this).find(".datacard").removeClass('dcardhover');
        (0, _jquery2.default)(this).find(".kora").removeClass('dcardhover');
        (0, _jquery2.default)(this).find("p.card-no").removeClass('cardno-hover');
    });
    (0, _jquery2.default)(window).scroll(function () {
        var inter = (0, _jquery2.default)(".Cards__container");
        var top_of_element = inter.offset().top;
        var bottom_of_element = inter.offset().top + inter.outerHeight();
        var top_of_screen = (0, _jquery2.default)(window).scrollTop();
        var bottom_of_screen = (0, _jquery2.default)(window).scrollTop() + window.innerHeight;
    ...
    var Topvideo = (0, _jquery2.default)(".products").offset().top;
    var count = 0;
    Topvideo = Topvideo - 300;
    (0, _jquery2.default)(window).scroll(function () {
        // console.log($(window).scrollTop());/
        if ((0, _jquery2.default)(window).scrollTop() > Topvideo && count == 0) {
            aud.play();
            var video = new TimelineMax();
            video.to(".video-R", 0.3, { x: -30, opacity: 1 }, 0.1).to(".video-L", 0.3, { x: 30, opacity: 1 }, 0.1).to(".v-line", 0.3, { x: 0, opacity: 1 }).to(".v-line2", 0.3, { x: 0, opacity: 1 }).to(".v-circle", 0.6, { scale: 1, opacity: 1 }).to(".v-scircle", 0.3, { scale: 1, opacity: 1 }).to(".v-lcircle", 0.3, { scale: 1, opacity: 1 });
            count = 1;
        }
        if (count != 1) {
            aud.pause();
    ...
    ////////// footer
    var path1 = (0, _jquery2.default)("#righl1 path"),
        length1 = path1[0].getTotalLength();
    var path2 = (0, _jquery2.default)("#righl2 path"),
        length2 = path2[0].getTotalLength();
    var path3 = (0, _jquery2.default)("#lefl1 path"),
        length3 = path3[0].getTotalLength();
    var path4 = (0, _jquery2.default)("#lefl2 path"),
        length4 = path4[0].getTotalLength();
    var tl = new TimelineMax();
    tl.set(path1, { attr: { "stroke-dasharray": length1, "stroke-dashoffset": length1 } }).set(path2, { attr: { "stroke-dasharray": length2, "stroke-dashoffset": length2 } }).set(path3, { attr: { "stroke-dasharray": length3, "stroke-dashoffset": length3 } }).set(path4, { attr: { "stroke-dasharray": length4, "stroke-dashoffset": length4 } });

    var f = new TimelineMax();
    f.from(".right", 0.5, { y: 150, opacity: 0 }, 1).from(".left", 0.5, { y: -150, opacity: 0 }, 1).call(function () {
        (0, _jquery2.default)('.right').addClass("animate");
    }, null, null, 1.5).call(function () {
        (0, _jquery2.default)('.left').addClass("animate");
    }, null, null, 1.5).addLabel("draw", "+=1").to(path1, 0.6, { attr: { "stroke-dashoffset": 0 }, opacity: 1 }, "draw").to(path2, 0.6, { attr: { "stroke-dashoffset": 0 }, opacity: 1 }, "draw+=0.4").to(path3, 0.6, { attr: { "stroke-dashoffset": 0 }, opacity: 1 }, "draw").to(path4, 0.6, { attr: { "stroke-dashoffset": 0 }, opacity: 1 }, "draw+=0.4");
    f.pause();
    var Topfooter = (0, _jquery2.default)(".footer").offset().top;
    (0, _jquery2.default)(window).scroll(function () {
        //     if($(window).scrollTop() > Topfooter)
        if ((0, _jquery2.default)(window).scrollTop() + (0, _jquery2.default)(window).height() > (0, _jquery2.default)(document).height() - 500) {
            f.play();
        }
    });
} else if ((0, _jquery2.default)(".page-template-coming-soon").length != 0) {
    var path11 = (0, _jquery2.default)(".top-drawLine1 path"),
        length11 = path11[0].getTotalLength();
    var path22 = (0, _jquery2.default)(".top-drawLine2 path"),
        length22 = path22[0].getTotalLength();
    var path33 = (0, _jquery2.default)(".botton-drawLine1 path"),
        length33 = path33[0].getTotalLength();
    var path44 = (0, _jquery2.default)(".botton-drawLine2 path"),
        length44 = path44[0].getTotalLength();

    var t = new TimelineMax();
    t.set(path11, { attr: { "stroke-dasharray": length11, "stroke-dashoffset": length11 } }).set(path22, { attr: { "stroke-dasharray": length22, "stroke-dashoffset": length22 } }).set(path33, { attr: { "stroke-dasharray": length33, "stroke-dashoffset": length33 } }).set(path44, { attr: { "stroke-dasharray": length44, "stroke-dashoffset": length44 } });

    var coming = new TimelineMax();
    coming.addLabel("img").from(".coming-soon__image__mainImage", 0.7, { yPercent: 50, opacity: 0 }, "img").from(".big-circle", 0.7, { scale: 0.2, opacity: 0 }, "img").from(".small-circle", 1.5, { scale: 0.2, opacity: 0 }).addLabel("show").from(".tall-top-line", 0.5, { y: 100, opacity: 0 }, "show").from(".tall-botton-line", 0.5, { y: 100, opacity: 0 }, "show").from(".short-top-line", 0.5, { y: 100, opacity: 0 }, "show+1").from(".short-botton-line", 0.5, { y: 100, opacity: 0 }, "show+1").addLabel("both").to(path11, 0.2, { attr: { "stroke-dashoffset": 0 }, opacity: 1 }, "both").to(path22, 0.6, { attr: { "stroke-dashoffset": 0 }, opacity: 1 }, "both").to(path33, 0.6, { attr: { "stroke-dashoffset": 0 }, opacity: 1 }, "both").to(path44, 0.6, { attr: { "stroke-dashoffset": 0 }, opacity: 1 }, "both");
}
...
$(".top").click(function () {
  $('html,body').animate({
    scrollTop: $(".main-container").offset().top }, 'slow');
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TweenMaxBase_js__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__CSSPlugin_js__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__AttrPlugin_js__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__RoundPropsPlugin_js__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__DirectionalRotationPlugin_js__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__TimelineLite_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__TimelineMax_js__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__BezierPlugin_js__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__EasePack_js__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TimelineLite_js__ = __webpack_require__(12);
...
var _foundation6 = __webpack_require__(40);

var _foundation7 = __webpack_require__(18);

var _foundation8 = __webpack_require__(41);

var _foundation9 = __webpack_require__(42);

var _foundation10 = __webpack_require__(43);

var _foundation11 = __webpack_require__(44);

var _foundation12 = __webpack_require__(45);

var _foundation13 = __webpack_require__(46);

var _foundation14 = __webpack_require__(47);

var _foundation15 = __webpack_require__(48);

var _foundation16 = __webpack_require__(49);

var _foundation17 = __webpack_require__(19);

var _foundation18 = __webpack_require__(50);

var _foundation19 = __webpack_require__(20);

var _foundation20 = __webpack_require__(51);

var _foundation21 = __webpack_require__(52);

var _foundation22 = __webpack_require__(53);
